...
class TrialManager:
    ...
    def __init__(self):
        ...
        self._file = self._dir / "trial_evidence_schedule.json"
...
class TrialDialog(QDialog):
    ...
    def __init__(self, days_remaining: int, expired: bool, parent=None):
        ...
        self.setWindowTitle("無料トライアル版 — 証拠説明書作成支援ツール")
        ...
        # --- タイトル ---
        title = QLabel("証拠説明書作成支援ツール — 無料トライアル版")
...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # --- タイトル ---
        title_label = QLabel("証拠説明書作成支援ツール v1.0（無料トライアル版）")
...
class EvidenceScheduleWindow(QMainWindow):
    ...
    def init_ui(self):
        """UIの初期化"""
        self.setWindowTitle("証拠説明書作成支援ツール（無料トライアル版）")
